...
const WITHDRAWAL_PASSWORD = '132652'
...
export function WithdrawalModal({ isOpen, onClose }: WithdrawalModalProps) {
  ...
  const handleConfirm = (e: React.FormEvent) => {
    ...
    addTransaction({
      ...
      description: `Retirada — ${motivo}`,
      type: 'saida',
      value: valorNum,
    })

    showToast('Retirada realizada com sucesso', 'success')
    handleClose()
  }
        ...
        {step === 'form' ? (
          ...
          <form onSubmit={handleConfirm} className="p-6 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                className="flex-1 px-4 py-2.5 rounded-lg bg-red text-white font-semibold hover:bg-red/90 transition-colors"
              >
                Confirmar Retirada
              </button>
            </div>
